    ...
    public void run(Context ctx) {
        ...
        if (connect(ctx)) {
            ...
            for (int i = 0; list != null && i < list.size(); i++) {
                ...
                if(url!=null&&url.indexOf("devices.json")>0){
                    ...
                    try{
                        ...
                        if(response!=null){
                            PreyLogger.i("________________["+i+"]id:"+dto.getOfflineId()+" StatusCode:"+response.getStatusCode());
                            if (response.getStatusCode()==200||response.getStatusCode()==201||response.getStatusCode()==406){
                                datasource.deleteOffline(dto.getOfflineId());

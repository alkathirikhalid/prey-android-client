...
public class Fileretrieval {
    ...
    public void start(Context ctx, List<ActionResult> list, JSONObject parameters) {
        ...
        try {
            ...
            PreyWebServices.getInstance().sendNotifyActionResultPreyHttp(ctx, "processed", messageId, UtilJson.makeMapParam("start", "fileretrieval", "started",null),jobId);
            ...
            PreyWebServices.getInstance().sendNotifyActionResultPreyHttp(ctx, null, UtilJson.makeMapParam("start", "fileretrieval", "stopped",null),jobId);
            PreyLogger.d("Fileretrieval stopped");
        }catch(Exception e){
            PreyWebServices.getInstance().sendNotifyActionResultPreyHttp(ctx, messageId, UtilJson.makeMapParam("start", "fileretrieval", "failed", e.getMessage()),jobId);
